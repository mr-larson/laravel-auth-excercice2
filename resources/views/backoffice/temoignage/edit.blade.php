...
@section('content')
    ...
    <div class="py-12">
        ...
        <!--Edit Card-->
        <form method="POST" class="backoffice_title grid grid-cols-1 bg-blue-200 rounded shadow-lg mx-auto p-3 w-3/5 mb-4 apparition" action="/temoignage/{{$temoignage->id}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="px-6 py-4">
