...
@section('content')
    ...
    <div class="py-12">
        ...
        <!--Edit Card-->
        <form method="POST" class="backoffice_title grid grid-cols-1 bg-blue-200 rounded shadow-lg mx-auto p-3 w-3/5 m-10 apparition" action="/counts/" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="px-6 py-4">
                <div class="m-3 col-span-2">
                    <label class="text-gray-700 text-base">Chiffre</label>
                    <input type="text" class="px-3 py-1 w-full rounded-md" name="figure">
                </div>
                <div class="m-3 col-span-2">
